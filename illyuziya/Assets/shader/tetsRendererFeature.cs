...
public sealed class tetsRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        tetsVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<tetsVolumeComponent>();
