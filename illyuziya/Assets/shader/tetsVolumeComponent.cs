...
[VolumeComponentMenu("Post-processing Custom/tets")]
[VolumeRequiresRendererFeatures(typeof(tetsRendererFeature))]
[SupportedOnRenderPipeline(typeof(UniversalRenderPipelineAsset))]
public sealed class tetsVolumeComponent : VolumeComponent, IPostProcessComponent
{
    public tetsVolumeComponent()
    {
        displayName = "tets";
    }
